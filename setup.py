...
def update_mirror_file():
    ...
    countries = list()
    try:
        with urlopen("https://raw.githubusercontent.com/fhdk/m-arm-web-repos/master/mirrors.json") as response:
...
setup(
    ...
    data_files=[('/etc', ['conf/pacman-mirrors.conf']),
                ...
                ('share/polkit-1/actions', ['policy/org.manjaro.pkexec.pacman-mirrors.policy']),
    ...
    scripts=["scripts/pacman-mirrors", "scripts/pm-launch"],
